...
const AboutGH = () => {
  return (
    <div className=" cursor-default">
      {/* <Navbar /> */}
      <main className=" p-6">
        <h1 className=" text-sky-950 lg:text-3xl sm:text-lg font-semibold text-center mt-5">
          Meet Mahmoud EL-Gyuoshi
        </h1>
        <div className=" lg:mx-16 my-20 grid lg:grid-cols-2 sm:grid-cols-1  justify-items-center mt-10 font-semibold ">
      ...
      {/* <hr className=" border-slate-600 mx-20 pb-10" /> */}
    </div>
  );
};
export default AboutGH;
